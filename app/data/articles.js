...
export const articles = [
  ...
  },
  {
    ...
    category: 'Land Acquisition',
    series: 'The Texas 30',
    summary: 'The 28-year-old President, Jordan Harmon, sat down for a podcast where he said they just want to stay true to who they are, give the shirt off their back, and build deep relationships with Texans doing what they love and have passion for along the way. "We wouldn\'t be able to compete with institutional-grade capital being deployed in the Texas market. Landowners do business with us because of who we are on the inside. I truly believe that."',
    content: "Haven Ground, formerly Harmon Land Company, has acquired ranch property along Texas's Aggie Expressway, adding to their 731-acre portfolio assembled over five years. Founded by 28-year-old CEO Jordan Harmon, the Houston-based company operates with a conservation-first philosophy, preserving nearly 90% of existing environment on legacy ranch developments. The company has expanded from Texas into six additional states including Mississippi, Tennessee, Colorado, Montana, Missouri, and Kentucky. With a team of twelve professionals, Haven Ground focuses on making land ownership accessible while maintaining ecological integrity—a timely approach as Texas rural land prices stabilize after years of rapid growth. The Aggie Expressway acquisition positions the company in one of Texas's emerging growth corridors, complementing their existing holdings in Terrell and properties throughout the Houston, Dallas, and Austin markets.",
    date: '2025-11-10',

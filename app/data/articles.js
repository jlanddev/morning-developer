...
export const articles = [
  ...
  // To re-publish: remove the `hidden: true` line below
  {
    ...
    summary: "How we get to positively impact folks has been at the core of our journey since day one. We want to build something the people who have been giving us opportunities, cheering us on, and believing in us can be proud of. Reid's Pine Estates will preserve 80% of the existing ranch and give Houston families a chance at owning 1 to 2 acre places to call home.",
    content: "Haven Ground, a Houston-based land investment firm, has closed on 52 acres in Waller, Texas, a move that puts the seven-year-old firm squarely in the path of one of the fastest-growing submarkets in the state. The deal was made in partnership with Jones Capital.\n\nThe community, named Reid's Pine Estates, will feature 1 to 2 acre places to call home, a rarity in a market dominated by 50 and 65 foot homesites. Haven Ground plans to preserve roughly 80 percent of the existing ranch land on the property, keeping the trees, open space, and rural character that drew people to Waller in the first place.\n\n\"We grew up out here,\" Harmon said. \"These are our neighbors, our churches, our Friday night lights. If we can help one more family own a piece of that, that's the whole point.\"\n\nDetails on the community are still being finalized, but Harmon confirmed the site will be developed with working families in mind, people who want land they can actually afford in a market that keeps pushing them further out.\n\n\"We're not building for press releases. We're building for the people we sit next to at church. The folks coaching little league with us. We want them to be able to stay close to the people they love and plant roots somewhere real.\"\n\nThe acquisition comes as institutional capital continues to pour into the 290 corridor, with large-scale master-planned communities and commercial projects reshaping the area west of the Grand Parkway. Haven Ground's acreage lot concept at Reid's Pine Estates is a different approach entirely, and Harmon says that's by design.\n\n\"Everybody's racing to build the next five-thousand-home subdivision. We'd rather build something where your neighbor knows your name and your kids ride bikes to each other's house. That's the Texas we grew up in and we're not ready to let go of it.\"\n\nHaven Ground currently operates across Texas, Mississippi, Tennessee, Colorado, Montana, Missouri, Kentucky, and several other states. The company has built its portfolio over seven years with a team of 12, focused on making land ownership accessible to everyday Americans.",
    date: formatDate(0),
  ...
  // CAPITAL
  {
    ...
    title: 'BlackRock Leads $40B Deal for Aligned Data Centers',
    category: 'Capital',
  ...
  {
    id: 'walton-250m-fund-launch',
    title: 'Walton Global Launches $250M Builder Land Finance Fund',
    category: 'Capital',
  ...
  {
    id: 'forestar-2b-land-investment',
    title: 'Forestar Plans $2B Land Acquisition Investment for FY2025',
    category: 'Capital',
  ...
  {
    id: 'lennar-1807-acres-texas',
    title: 'Lennar Acquires 1,807 Acres for 4,000-Home Community in North Texas',
    category: 'Land Acquisition',
  ...
  {
    id: 'walton-126-acres-dallas',
    title: 'Walton Global Closes on 126 Acres in Dallas-Fort Worth',
    category: 'Land Acquisition',
  ...
  {
    id: 'lennar-taylor-morrison-600-lots',
    title: 'Lennar and Taylor Morrison Snap Up 600 Lots in Arizona for $54M',
    category: 'Land Acquisition',
  ...
  // MIXED-USE
  {
    id: 'seaflower-bradenton-4000-homes',
    title: 'SeaFlower Mixed-Use Development Welcomes First Residents in Bradenton',
    category: 'Mixed-Use',
  ...
  {
    id: 'veridea-apex-3b-project',
    title: 'RXR Breaks Ground on $3B Veridea Master-Planned Community in North Carolina',
    category: 'Mixed-Use',
  ...
  {
    id: 'south-pier-tempe-1-8b',
    title: 'South Pier Tempe Waterfront Project Tops Out First Phase',
    category: 'Mixed-Use',
  ...
  // RESIDENTIAL
  {
    id: 'forestar-14240-lots-delivered',
    title: 'Forestar Delivers 14,240 Residential Lots in Fiscal 2025',
  ...
  {
    id: 'institutional-real-estate-recovery',
    title: 'Institutional Real Estate Shows Signs of Robust Recovery in 2025',
    category: 'Capital',
...
export const categories = {
  'Capital': 'Institutional investments, fundraising, capital markets, and major financial transactions in real estate development',
  'Land Acquisition': 'Major land purchases, lot banking deals, and strategic acquisitions by developers and homebuilders',
  'Mixed-Use': 'Master-planned communities, mixed-use developments, and innovative urban projects',
  'Residential': 'Homebuilding projects, residential lot development, and housing market trends'
};
